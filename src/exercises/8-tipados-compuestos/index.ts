...
// El tipo PowerUser excluye las propiedades 'type' de User y Admin, y añade sus propias propiedades.
// Ya que PowerUser contiene las propiedades de User y Admin, pero con un tipo específico 'powerUser'.
